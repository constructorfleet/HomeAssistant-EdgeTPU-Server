...
RUN LD_PRELOAD=/usr/lib/arm-linux-gnueabihf/libatomic.so.1.2.0  python3 -m pip install  -e . \
    && LD_PRELOAD=/usr/lib/arm-linux-gnueabihf/libatomic.so.1.2.0 python3 setup.py bdist_wheel \
